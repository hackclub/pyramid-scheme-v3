...
# WEBrick for worker health check server (removed from stdlib in Ruby 3.4)
gem "webrick"
...
group :development do
  ...
  # Run Procfile.dev (web + css) with `bin/dev`
  gem "foreman"
end
...
group :test do
  ...
  # HTTP request stubbing for service tests
...
# Country data for map feature
gem "countries", "~> 8.1"

# Background jobs (already have solid_queue)
