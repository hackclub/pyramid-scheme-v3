...
export default class extends Controller {
  ...
  async loadData(metric) {
    try {
      ...
      // For users metric, v2 data is global (not per-campaign)
      const isUsersMetric = metric === "users"
      
      const datasets = isUsersMetric ? [
        {
          label: "Pyramid v2",
          data: data.v2_athena, // v2_athena contains global users for users metric
          borderColor: "#8b5cf6",
