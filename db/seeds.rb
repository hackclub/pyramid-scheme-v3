...
campaigns_data = [
  ...
  },
  {
    ...
    name: "Aces",
    theme: "aces",
    description: "Build your own digital board/card game, earn cards through our shop to get your ticket to The Deck - a 48 hour hackathon in Washington DC during AwesomeCon!",
    active: true,
    status: "coming_soon",
    referral_shards: 3,
    poster_shards: 1,
